...
public class DataReceiver {
	...
	public static JSONArray eventReceiver(String cityLat, String cityLong, String year, String month, String day,
			String magnitude, String source, String username, String password, Logger logger) {
		...
		String urlToRead = "https://webservices.ingv.it/fdsnws/event/1/query?starttime=" + date + "T00:00:00&endtime="
				+ enddate + "T23:59:59&minmagnitude=" + magnitude + "&format=text&lat=" + cityLat + "&lon=" + cityLong
				+ "&maxradiuskm=50";
